...
export async function sendVerificationEmail(email, token, fullName, host) {
  ...
  if (process.env.RESEND_API_KEY) {
    console.log(`[MAILER] Dispatching actual verification email to ${email} via Resend...`);
    ...
    console.log(`[MAILER] Verification email successfully sent via Resend to ${email}`);
    ...
    try {
      ...
      console.warn(`[MAILER] Simulated local email preview could not be saved to disk (read-only serverless filesystem):`, fsError.message);
    }
  }
}
