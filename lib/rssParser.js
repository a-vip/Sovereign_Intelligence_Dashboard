...
export const RSS_FALLBACK = [
  ...
  { title: 'UN General Assembly adopts landmark resolution on autonomous weapon systems regulation', url: 'https://news.un.org/en/story/2024/05/un-resolution-killer-robots', published_at: '2026-05-15T12:00:00.000Z', source: 'UN News', sid: 'un', location: 'UN Headquarters NY', latitude: 40.7489, longitude: -73.9680, category: 'Political', severity: 3 },
  { title: 'Pegasus spyware detected on phones of state department officials', url: 'https://www.wired.com/story/pegasus-spyware-state-department-detection', published_at: '2026-05-14T12:00:00.000Z', source: 'Wired AI & Security', sid: 'wired', location: 'San Francisco HQ', latitude: 37.7749, longitude: -122.4194, category: 'Surveillance', severity: 4 },
  { title: 'EFF sues DHS over illegal biometric face scanning at regional border checkpoints', url: 'https://www.eff.org/press/releases/eff-sues-dhs-over-illegal-biometric-face-scanning', published_at: '2026-05-13T12:00:00.000Z', source: 'EFF Updates', sid: 'eff', location: 'EFF SF Office', latitude: 37.7749, longitude: -122.4194, category: 'Surveillance', severity: 3 },
